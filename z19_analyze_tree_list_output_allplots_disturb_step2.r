...
# calculate overall accuracy = 72.5%  
dymat2[dim(dymat2)[[1]], dim(dymat2)[[2]]]  <- (dymat2[1,1] + dymat2[2,2] + dymat2[3,3] + dymat2[4,4] + dymat2[5,5] + dymat2[6,6] + dymat2[7,7] + dymat2[8,8] + dymat2[9,9] + dymat2[10,10] + dymat2[11,11] + dymat2[12,12] + dymat2[13,13] + dymat2[14,14] + dymat2[15,15])/sum(dymat)
write.table(dymat2, paste(curfolder, "\\", curzone, "_disturb_year_confusion_matrix.txt", sep=""))
# bar chart
dyplottotals <- c(sum(dymat[,1]), sum(dymat[,2]), sum(dymat[,3]), sum(dymat[,4]), sum(dymat[,5]), sum(dymat[,6]), sum(dymat[,7]), sum(dymat[,8]), sum(dymat[,9]), sum(dymat[,10]), sum(dymat[,11]), sum(dymat[,12]), sum(dymat[,13]), sum(dymat[,14]), sum(dymat[,15]))
sum(dyplottotals)
dypolytotals <- c(sum(dymat[1,]), sum(dymat[2,]), sum(dymat[3,]), sum(dymat[4,]), sum(dymat[5,]), sum(dymat[6,]), sum(dymat[7,]), sum(dymat[8,]), sum(dymat[9,]), sum(dymat[10,]), sum(dymat[11,]), sum(dymat[12,]), sum(dymat[13,]), sum(dymat[14,]), sum(dymat[15,]))
sum(dypolytotals)
